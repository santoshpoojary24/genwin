      ...
      <div className="flex-1 flex flex-col justify-between p-6 sm:p-12">
        ...
        <div className="w-full max-w-sm mx-auto space-y-6 my-auto py-8">
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3.5 bg-zinc-50 border border-zinc-300 hover:border-black text-black font-bold text-xs uppercase tracking-wider flex items-center justify-center gap-3 transition-colors press"
          >
