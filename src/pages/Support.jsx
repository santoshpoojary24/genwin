  ...
  return (
    <div className="min-h-screen bg-white text-black font-mono page-enter pb-24">
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-12 py-12 space-y-12">
        ...
        {/* TAB 2: LOOKUP TICKET STATUS */}
        {activeTab === 'lookup' && (
          <div className="space-y-8 max-w-3xl mx-auto">
            <form onSubmit={handleLookupTicket} className="space-y-3">
              <label className="block text-[10px] font-bold text-zinc-500 uppercase tracking-widest">
                ENTER TICKET NUMBER (e.g. TKT-849201) OR YOUR EMAIL ADDRESS
              </label>
              <div className="flex gap-2">
                <input
                  ...
                  placeholder="e.g. TKT-1092 OR CUSTOMER@EMAIL.COM"
                  ...
                  <div className="space-y-4">
                    {foundTickets.map(t => (
                      <div key={t.id || t.ticketId} className="bg-zinc-950 text-white border border-zinc-800 p-6 space-y-4 font-mono text-xs">
                        ...
                        {t.responseNote && (
                          <div className="bg-emerald-950/60 border border-emerald-800 p-4 space-y-1">
                            <div className="flex items-center justify-between">
                              <span className="text-[10px] text-emerald-400 font-bold uppercase">OFFICIAL EMPLOYEE RESOLUTION RESPONSE</span>
                              <span className="text-[9px] text-zinc-400">Assigned: {t.assignedTo || 'Support Staff'}</span>
                            </div>
                            <p className="text-white text-xs leading-relaxed font-bold uppercase">{t.responseNote}</p>
                          </div>
                        )}
                      </div>
                    ))}
